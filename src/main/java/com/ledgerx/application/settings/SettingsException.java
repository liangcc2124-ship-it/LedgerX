...
/** Stable settings failure that the HTTP adapter can expose in the global error envelope. */
public final class SettingsException extends Exception {
    ...
    public SettingsException(int httpStatus, String code, String message) {
